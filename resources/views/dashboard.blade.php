...
<div>
    <form action="" method="post" id="GroupSearchForm">
        @csrf
    <h4>Groups</h4>
    Search: <input type="text" name="GroupSearch"> <button type="submit" name="GroupSearchButton">Submit</button>
    <ul>
